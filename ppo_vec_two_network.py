...
from utils import ElementHandler
...
if __name__ == "__main__":
    ...
    if args.load_weight_infer:
        agent_infer.load_state_dict(torch.load(args.load_weight_infer))
    ...
    next_obs_all, _ = envs.reset(seed=args.seed)
    next_obs, next_obs_infer = handler.split(next_obs_all)
    ...
    for iteration in tqdm(range(1, args.num_iterations + 1)):
        ...
        for step in range(0, args.num_steps):
            ...
            with torch.no_grad():
                ...
                action_infer, _, _, _ = agent_infer.get_action_and_value(next_obs_infer)
